        ...
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
                <a href="index.html" class="b-brand">
                    ...
                    <span class="b-title">WIO_SERVICE</span>
                </a>
                    ...
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                    ...
                                    <div class="card Daily-sales">
										...
										<h6 class="mb-4">일간</h6>
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-down-right text-c-blue f-30 m-r-10"></i>800</h3>
                                                </div>

                                                <div class="col-3 text-right">
                                                    <p class="m-b-0">전일 890</p>
                                                </div>
                                        ...
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center card-active">
                                                <div class="col-6">
                                                    <h6 class="text-center m-b-10"><span class="text-muted m-r-5">처리:</span>35,098</h6>
                                                    <div class="progress">
                                                ...
                                                <div class="col-6">
                                                    <h6 class="text-center  m-b-10"><span class="text-muted m-r-5">미처리:</span>3,539</h6>
                                                    <div class="progress">
                                ...
                                <!--[ daily CALL section ] end-->
								
								<!--[ Weekly  CALL section ] starts-->
                                 <div class="col-md-6 col-xl-4">
                                ...
                                <!--[ Weekly  CALL section ] end-->
                               

                                <!--[ Monthly  CALL section ] starts-->
                                 <div class="col-md-6 col-xl-4">
                                    <div class="card Weekly-sales">
                                        <div class="card-block  border-bottom">
										<h6 class="mb-4">월간</h6>
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-arrow-up-right text-c-red f-30 m-r-10"></i>800</h3>
                                                </div>

                                                <div class="col-3 text-right">
                                                    <p class="m-b-0">전월 890</p>
                                                </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card daily-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">신규 인입 고객 (오늘) </h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center m-b-0"><i class="feather icon-user-plus text-c-blue f-30 m-r-10"></i>2 </h3>
                                                </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card Monthly-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">신규 인입 고객 (월간) </h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-user-plus text-c-red f-30 m-r-10"></i>100 </h3>
                                                </div>
                                                <div class="col-3 text-right">
                                                    <p class="m-b-0">36%</p>
                                                </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card yearly-sales">
                                        <div class="card-block">
                                            <h6 class="mb-4">전체 고객 </h6>
                                            <div class="row d-flex align-items-center">
                                                <div class="col-9">
                                                    <h3 class="f-w-300 d-flex align-items-center  m-b-0"><i class="feather icon-users text-c-green f-30 m-r-10"></i>3,408 </h3>
                                                </div>
                                ...
                                <div class="col-xl-4 col-md-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block border-bottom">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto">
                                                    <i class="feather icon-phone f-30 text-c-green"></i>
                                                </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">450,000</h3>
                                                    <span class="d-block text-uppercase">오늘</span>
                                                </div>
                                            </div>
                                        </div>
										<div class="card-block border-bottom" >
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto">
                                                    <i class="feather icon-pie-chart f-30 text-c-blue"></i>
                                                </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">2,584,000</h3>
                                                    <span class="d-block text-uppercase">이번달</span>
                                                </div>
                                            </div>
                                        </div>
										<div class="card-block border-bottom" >
                                            <div class="row d-flex align-items-center">
                                                ...
                                                <div class="col">
                                                    <h3 class="f-w-300">756,200</h3>
                                                    <span class="d-block text-uppercase">웹 처리</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-block">
                                            <div class="row d-flex align-items-center">
                                                <div class="col-auto">
                                                    <i class="feather icon-type f-30 text-c-blue"></i>
                                                </div>
                                                <div class="col">
                                                    <h3 class="f-w-300">1,025,000</h3>
                                                    <span class="d-block text-uppercase">잔여 마일리지</span>
                                                </div>
                                            </div>
                                        </div>
...
<script src="assets/js/vendor-all.min.js"></script>
    ...
    <script src="assets/js/pages/chart-morris-dash.js"></script>
</body>
</html>
